export const seedData = {
  ...
  faculty: [
    ...
    { name: 'Dr. Marcus Hill', department: 'Data Science and Analytics', specialization: 'Data Ethics and Governance', courses: ['DS 5410'], load: 'Low', availability: 'Available', status: 'Active', conflict: 'None' },
    { name: 'Dr. Lauren Brooks', department: 'Data Science and Analytics', specialization: 'Research Capstone Assessment', courses: ['DS 5990'], load: 'Moderate', availability: 'Available', status: 'Active', conflict: 'Committee member' },
    ...
    { name: 'Dr. Hannah Ortiz', department: 'Environmental Engineering', specialization: 'Environmental Sensor Networks', courses: ['ENV 6310'], load: 'Moderate', availability: 'Available', status: 'Active', conflict: 'None' },
    { name: 'Dr. Kenji Watanabe', department: 'Environmental Engineering', specialization: 'Environmental Systems Review', courses: ['ENV 6900'], load: 'Low', availability: 'Available', status: 'Active', conflict: 'Committee member' },
    { name: 'Dr. Victor Ames', department: 'Environmental Engineering', specialization: 'Graduate Assessment Design', courses: ['ENV 6200'], load: 'Moderate', availability: 'Available', status: 'Active', conflict: 'Co-advisor' }
  ],
  courses: [
